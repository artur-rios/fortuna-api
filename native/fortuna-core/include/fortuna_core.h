...
int fortuna_api_recurring_transactions_get(const char *request_json, char **response_json); /* GET /api/recurring-transactions */
...
int fortuna_api_transactions_by_id_attachments_get(const char *request_json, char **response_json); /* GET /api/transactions/{id}/attachments */
