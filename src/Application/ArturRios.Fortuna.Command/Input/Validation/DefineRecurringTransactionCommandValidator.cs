...
public sealed class DefineRecurringTransactionCommandValidator
    : AbstractValidator<DefineRecurringTransactionCommand>
{
    public DefineRecurringTransactionCommandValidator()
    {
