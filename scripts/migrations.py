#!/usr/bin/env python3
"""Interactive menu for the Fortuna's EF Core migrations.

Lists, creates and applies migrations for ArturRios.Fortuna.Data, loading the
...
ENVIRONMENTS_DIR = REPO_ROOT / "src/Presentation/ArturRios.Fortuna.WebApi/Environments"
DATA_PROJECT = REPO_ROOT / "src/Infrastructure/ArturRios.Fortuna.Data"
STARTUP_PROJECT = DATA_PROJECT

CONNECTION_STRING_VARIABLE = "FORTUNA_DATA_CONNECTIONSTRING"
